<template>
  <div>
    ...
    <List v-show="tabOpen == 'list' && acl.read == 1" v-bind:items="items" v-bind:unsigned="unsigned"
          v-bind:acl="acl" v-bind:groups="groups"></List>
    <Item v-if="tabOpen == 'item' && acl.read == 1" v-bind:item="item"
          v-bind:acl="acl" v-bind:groups="groups" v-bind:showDays="showDays" ></Item>

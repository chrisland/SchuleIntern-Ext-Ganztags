        ...
        <div class="si-userselect-modal-box" >
          <div class="si-userselect-modal-content">
            ...
            <div class="list">
              <ul class="userlist">
                <span v-if="users">
                  <li v-bind:key="index" v-for="(item, index) in  users" v-on:click="handlerSelectUser($event, item)"
                ...
                <ul>
                  ...
                  <li v-if="selected">
                    ...
                    <div v-if="selected.length > 0" >
                      <ul class="selected">
                        <li v-bind:key="index" v-for="(item, index) in  selected" v-on:click="handlerSelectUser($event, item)">
                          <span class="flex-1 flex-row">
                            <div class="flex-1"><img :src="item.avatar" class="width-3rem height-3rem"/></div>
...
export default {
  ...
  props: {
    preselected: Array,
    parent: Object | Array | Number | String
  },
  mounted: function () {
  ...
  methods: {
    ...
    handlerSelectAll: function () {
      this.users.forEach((item)  => {
        this.handlerSelectUser(false, item);
      });
    },
    ...
    handlerSubmit: function () {
      this.$emit('finish', this.selected, this.parent)
      this.handlerCloseForm();
    },
    handlerSelectUser: function ($event,  user) {
      let found = false;

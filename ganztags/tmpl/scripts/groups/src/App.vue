<template>
  <div >
    ...
    <button v-if="acl.write == 1" class="si-btn" v-on:click="handlerAddItem"><i class="fa fa-plus"></i> Neue Gruppe</button>
    ...
    <table class="si-table si-table-style-allLeft ">
      ...
      <tr v-bind:key="index" v-for="(item, index) in  items">
        <td class="">
          <input v-if="acl.write == 1" type="text" v-model="item.title" class="si-input">
        ...
        <td class="">
          <input v-if="acl.write == 1" type="text" v-model="item.room" class="si-input">
          <span v-else-if="acl.read == 1">{{item.room}}</span>
        </td>
        <td class="">
          <input v-if="acl.write == 1" type="text" v-model="item.color" class="si-input">
        ...
        <td class="">
          <input v-if="acl.write == 1" type="text" v-model="item.duration" class="si-input">
